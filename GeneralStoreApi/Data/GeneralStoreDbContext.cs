...
public partial class GeneralStoreDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Customer__3214EC07094DE8D5");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Products__3214EC073C8029BC");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Transact__3214EC07C0DF7C82");
